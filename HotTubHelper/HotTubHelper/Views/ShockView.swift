...
struct ShockView: View {
    ...
    var product: String {
        ...
        case .chlorine: return "Cal-hypo 68%"
        case .bromine: return "Non-chlorine shock (MPS)"
        }
    }
    ...
    var body: some View {
        Form {
            ...
            Section {
                StepRow(number: 1, text: "Remove the cover and run the jets.")
                StepRow(number: 2, text: "Add the shock with the jets running for at least 15 minutes.")
                StepRow(number: 3, text: "Leave the cover off for 20–30 minutes before closing.")
                StepRow(
                    number: 4,
